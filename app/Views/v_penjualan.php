...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-pink">
    <div class="container">
      <a href="../../index3.html" class="navbar-brand">
        <span class="brand-text font-text-pink"><i class="fas fa-shopping-cart text-black "></i><b> Transaksi Penjualan</b></span>
      </a>
        ...
        <div class="row">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <label class="form-control form-control-lg text-pink"><?= $no_faktur?></label>
                </div>
                </div>
                ...
                <div class="form-group">
                    <label>Kasir</label>
                    <label class="form-control form-control-lg text-pink"><?= session()->get('nama_user') ?></label>
                </div>
                </div>
          ...
          <div class="col-lg-5">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-pink color-palette text-right">
                  <label class="display-4 text-black">Rp. <?= number_format($grand_total, 0)?>.-</h1>
              </div>
            </div>
          </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <span class="input-group-append">
                  <span class="btn btn-primary btn-flat" data-toggle="modal" data-target="#cari-produk">
                ...
                <div class="col-3">
                  ...
                  <div class="col-3">
                    <button type="submit" class="btn btn-flat btn-danger"><i class="fas fa-cart-plus">Add</i></button>
  ...
  <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-pink color-palette text-center">
                  <h1 class=" text-black" id="terbilang"></h1>
              </div>
            </div>
          </div>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                  ...
                  <input name="grand_total" id="grand_total" value="<?= number_format($grand_total, 0)?>" class="form-control text-right text-danger" readonly>
              </div>
              </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <input name="dibayar" id="dibayar" class="form-control text-success text-right" autocomplete="off">
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input name="kembalian" id="kembalian" class="form-control text-primary text-right" readonly>
              </div>
              </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>12 RPL 1 2023-2024 <a href="https://adminlte.io">SMKN 2 KUNINGAN</a>.</strong>
  </footer>
</div>
<!-- ./wrapper -->
